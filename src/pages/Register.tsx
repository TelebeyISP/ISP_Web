        ...
        <div className="hidden md:block h-full relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-10">
            <div className="text-white space-y-2">
              <h2 className="text-3xl font-bold">Join Telebey</h2>
              <p className="text-white/80">Experience the next generation of mobile connectivity.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 space-y-6">
          <div className="text-center md:text-left space-y-1">
            <div className="inline-flex items-center gap-2">
              ...
              <span className="text-2xl font-heading font-bold">Create Account</span>
            </div>
            <p className="text-muted-foreground text-sm pt-1">Start your journey with us today</p>
          </div>
